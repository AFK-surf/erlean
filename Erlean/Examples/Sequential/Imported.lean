...
private def importedSequentialModule_part_0 : Erlean.Core.FunctionDef :=
{ name := ("reverse"), params := ([0]), body := (Erlean.Core.Expr.caseE
...
private def importedSequentialModule_part_1 : Erlean.Core.FunctionDef :=
{ name := ("reverse_acc"), params := ([0, 1]), body := (Erlean.Core.Expr.caseE
...
private def importedSequentialModule_part_2 : Erlean.Core.FunctionDef :=
{ name := ("append"), params := ([0, 1]), body := (Erlean.Core.Expr.caseE
  (Erlean.Core.Expr.values [Erlean.Core.Expr.var 0, Erlean.Core.Expr.var 1])
  [([Erlean.Core.Pattern.lit (Erlean.Core.Value.nil), Erlean.Core.Pattern.var 2],
    Erlean.Core.Expr.lit (Erlean.Core.Value.atom "true"),
    Erlean.Core.Expr.var 2),
   ([Erlean.Core.Pattern.cons (Erlean.Core.Pattern.var 2) (Erlean.Core.Pattern.var 3), Erlean.Core.Pattern.var 4],
    ...
    Erlean.Core.Expr.letE
      [5]
      (Erlean.Core.Expr.apply (Erlean.Core.Expr.funRef "append" 2) [Erlean.Core.Expr.var 3, Erlean.Core.Expr.var 4])
    ...
    Erlean.Core.Expr.primop
      ...
      [Erlean.Core.Expr.tuple
         [Erlean.Core.Expr.lit (Erlean.Core.Value.atom "function_clause"),
          Erlean.Core.Expr.var 2,
          Erlean.Core.Expr.var 3]])]) }
private def importedSequentialModule_part_3 : Erlean.Core.FunctionDef :=
{ name := ("classify"), params := ([0]), body := (Erlean.Core.Expr.caseE
  (Erlean.Core.Expr.var 0)
  [([Erlean.Core.Pattern.var 1],
   ...
   ([Erlean.Core.Pattern.var 1],
    ...
    Erlean.Core.Expr.primop
      ...
      [Erlean.Core.Expr.tuple
         [Erlean.Core.Expr.lit (Erlean.Core.Value.atom "function_clause"), Erlean.Core.Expr.var 1]])]) }
private def importedSequentialModule_part_4 : Erlean.Core.FunctionDef :=
{ name := ("arithmetic"), params := ([0, 1]), body := (Erlean.Core.Expr.caseE
  (Erlean.Core.Expr.values [Erlean.Core.Expr.var 0, Erlean.Core.Expr.var 1])
  [([Erlean.Core.Pattern.var 2, Erlean.Core.Pattern.var 3],
    Erlean.Core.Expr.lit (Erlean.Core.Value.atom "true"),
    Erlean.Core.Expr.letE
    ...
    Erlean.Core.Expr.primop
      ...
      [Erlean.Core.Expr.tuple
         [Erlean.Core.Expr.lit (Erlean.Core.Value.atom "function_clause"),
          Erlean.Core.Expr.var 2,
          Erlean.Core.Expr.var 3]])]) }
private def importedSequentialModule_part_5 : Erlean.Core.FunctionDef :=
  ...
  [([Erlean.Core.Pattern.var 1], Erlean.Core.Expr.lit (Erlean.Core.Value.atom "true"), Erlean.Core.Expr.var 1),
   ([Erlean.Core.Pattern.var 1],
    ...
    Erlean.Core.Expr.primop
      ...
      [Erlean.Core.Expr.tuple
         [Erlean.Core.Expr.lit (Erlean.Core.Value.atom "function_clause"), Erlean.Core.Expr.var 1]])]) }
private def importedSequentialModule_part_6 : Erlean.Core.FunctionDef :=
{ name := ("context"), params := ([0]), body := (Erlean.Core.Expr.caseE
  (Erlean.Core.Expr.var 0)
  [([Erlean.Core.Pattern.var 1],
    Erlean.Core.Expr.lit (Erlean.Core.Value.atom "true"),
    Erlean.Core.Expr.letE
      ...
      (Erlean.Core.Expr.letE
        [3]
        (Erlean.Core.Expr.apply (Erlean.Core.Expr.funRef "identity" 1) [Erlean.Core.Expr.var 1])
        (Erlean.Core.Expr.tuple [Erlean.Core.Expr.var 2, Erlean.Core.Expr.var 1, Erlean.Core.Expr.var 3]))),
   ([Erlean.Core.Pattern.var 1],
    Erlean.Core.Expr.lit (Erlean.Core.Value.atom "true"),
    Erlean.Core.Expr.primop
      "match_fail"
      [Erlean.Core.Expr.tuple
         [Erlean.Core.Expr.lit (Erlean.Core.Value.atom "function_clause"), Erlean.Core.Expr.var 1]])]) }
private def importedSequentialModule_part_7 : Erlean.Core.FunctionDef :=
{ name := ("tuple_order"), params := ([]), body := (Erlean.Core.Expr.caseE
...
private def importedSequentialModule_part_8 : Erlean.Core.FunctionDef :=
{ name := ("cons_order"), params := ([]), body := (Erlean.Core.Expr.caseE
  (Erlean.Core.Expr.values [])
  [([],
    Erlean.Core.Expr.lit (Erlean.Core.Value.atom "true"),
    Erlean.Core.Expr.letE
   ...
   ([],
    ...
    Erlean.Core.Expr.primop
      "match_fail"
      [Erlean.Core.Expr.lit (Erlean.Core.Value.tuple [Erlean.Core.Value.atom "function_clause"])])]) }
private def importedSequentialModule_part_9 : Erlean.Core.FunctionDef :=
{ name := ("loop"), params := ([]), body := (Erlean.Core.Expr.caseE
  (Erlean.Core.Expr.values [])
  [([],
    Erlean.Core.Expr.lit (Erlean.Core.Value.atom "true"),
   ...
   ([],
    ...
    Erlean.Core.Expr.primop
      "match_fail"
      [Erlean.Core.Expr.lit (Erlean.Core.Value.tuple [Erlean.Core.Value.atom "function_clause"])])]) }
private def importedSequentialModule_part_10 : Erlean.Core.FunctionDef :=
  ...
  [([],
   ...
   ([],
    ...
    Erlean.Core.Expr.primop
      "match_fail"
      [Erlean.Core.Expr.lit (Erlean.Core.Value.tuple [Erlean.Core.Value.atom "function_clause"])])]) }
private def importedSequentialModule_part_11 : Erlean.Core.FunctionDef :=
...
{ name := ("sequential")
  exports := [(("append", 2)), (("arithmetic", 2)), (("classify", 1)), (("cons_order", 0)), (("context", 1)), (("identity", 1)), (("loop", 0)), (("module_info", 0)), (("module_info", 1)), (("reverse", 1)), (("tuple_order", 0))]
  functions := [importedSequentialModule_part_0, importedSequentialModule_part_1, importedSequentialModule_part_2, importedSequentialModule_part_3, importedSequentialModule_part_4, importedSequentialModule_part_5, importedSequentialModule_part_6, importedSequentialModule_part_7, importedSequentialModule_part_8, importedSequentialModule_part_9, importedSequentialModule_part_10, importedSequentialModule_part_11]
  closureCode := [] }

attribute [reducible] importedSequentialModule_part_0 importedSequentialModule_part_1 importedSequentialModule_part_2 importedSequentialModule_part_3 importedSequentialModule_part_4 importedSequentialModule_part_5 importedSequentialModule_part_6 importedSequentialModule_part_7 importedSequentialModule_part_8 importedSequentialModule_part_9 importedSequentialModule_part_10 importedSequentialModule_part_11
